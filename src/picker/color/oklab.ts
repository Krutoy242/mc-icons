...
// sRGB → OkLab (Björn Ottosson's coefficients). Matches culori's
// `converter('oklab')` to within ~4e-8 over the full 24-bit gamut.
...
// sRGB gamma decode (0..255 → linear 0..1). Shared by rgbToLab and mixRgb.
